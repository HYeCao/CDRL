...
def get_all_pivots(source_domain, target_domain):
    ...
    fname1 = "./work/bestpivots/%s_%s_pos.txt" % (source_domain, target_domain)
    pos_pivot = get_pivot_list(fname1)
    print pos_pivot

    fname1 = "./work/bestpivots/%s_%s_neg.txt" % (source_domain, target_domain)
    neg_pivot = get_pivot_list(fname1)
    print neg_pivot

    return pos_pivot, neg_pivot

def get_pivot_list(fname1):
...
# data vectorize include the data and pivot+non-pivots features
